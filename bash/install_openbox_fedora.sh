...
sudo dnf install openbox tint2 obconf compton volumeicon nitrogen obmenu xfce4-notifyd conky xscreensaver lxqt-openssh-askpass xfce4-power-manager blueman arandr thunar gmrun leafpad lxappearance network-manager-applet xbacklight flameshot playerctl mate-calc
...
# I really should try to roll this into either a kickstart file, or something more automated... :)