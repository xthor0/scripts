...
repo --name="rpmfusion-free-updates" --mirrorlist=https://mirrors.rpmfusion.org/mirrorlist?repo=free-fedora-updates-released-31&arch=x86_64
...
repo --name="rpmfusion-nonfree-updates" --mirrorlist=https://mirrors.rpmfusion.org/mirrorlist?repo=nonfree-fedora-updates-released-31&arch=x86_64
...
# spotify
dnf config-manager --add-repo=https://negativo17.org/repos/fedora-spotify.repo && dnf -y install spotify-client
...
gpg --armor --export 7568D9BB55FF9E5287D586017AE645C0CF8E292A > key.tmp && rpm --import key.tmp && rm -f key.tmp && dnf -y install pritunl-client-electron
...
# set the spinner theme to the hot-dog one, because I can
