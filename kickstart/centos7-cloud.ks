...
# System language
lang en_US.UTF-8
repo --name "os" --baseurl="http://mirror.xmission.com/centos/7/os/x86_64/" --cost=100
repo --name "updates" --baseurl="http://mirror.xmission.com/centos/7/updates/x86_64/" --cost=100
repo --name "extras" --baseurl="http://mirror.xmission.com/centos/7/extras/x86_64/" --cost=100
# Network information
